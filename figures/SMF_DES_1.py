...
for z_smf in z_smf_arr:
    ...
    line3 = ax_Pk.plot([0], [0], label=r'$T_{1}=-1$', color=colors[0][-1])   
    line2 = ax_Pk.plot([0], [0], label=r'$T_{1}=0$', color=colors[1][-1])
    line1 = ax_Pk.plot([0], [0], label=r'$T_{1}=1$', color=colors[2][-1])
