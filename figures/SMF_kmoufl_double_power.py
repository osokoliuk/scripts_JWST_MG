...
for z_smf in z_smf_arr:
    ...
    for ii in range(obs.n_target_observation):
        ...
        color = 'k'
        ax_Pk.errorbar(1,1,yerr=1,label=r'$\rm JWST$',capsize=0,ecolor=color,color='w',marker='v',markersize=4,markeredgewidth=1, elinewidth=1.2,ls='None',markeredgecolor=color,zorder=3)
