...
with open('double_power_SMF_E11_likelihood.pkl', 'wb') as f:
    pickle.dump(log_likelihood_int, f)
#with open('double_power_SMF_E11_likelihood.pkl', 'rb') as f:
...
def log_prior(theta):
    par1, par2, f0 = theta
    if (-1 < par1 < 2 and -1 < par2 < 2 and 0.001 < f0 < 1):
        return 0
    return -np.inf
