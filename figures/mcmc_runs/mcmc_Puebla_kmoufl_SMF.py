...
with open('Puebla_SMF_kmoufl_likelihood.pkl', 'wb') as f:
    pickle.dump(log_likelihood_int, f)
#with open('Puebla_SMF_kmoufl_likelihood.pkl', 'rb') as f:
...
samples.saveAsText("Puebla_kmoufl_SMF")
