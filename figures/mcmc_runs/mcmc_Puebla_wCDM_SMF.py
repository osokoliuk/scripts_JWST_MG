...
with open('Puebla_SMF_wCDM_likelihood.pkl', 'wb') as f:
    pickle.dump(log_likelihood_int, f)
with open('Puebla_SMF_wCDM_likelihood.pkl', 'rb') as f:
